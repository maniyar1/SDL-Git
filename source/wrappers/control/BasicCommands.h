...
auto constexpr PLAYER_UP_KEYUP = [](Point* p) {
    if (p->y < 0) {
        p->y = 0;
    }
};
...
auto constexpr PLAYER_DOWN_KEYUP = [](Point* p) {
    if (p->y > 0) {
        p->y = 0;
    }
};
...
auto constexpr PLAYER_RIGHT_KEYUP = [](Point* p) {
    if (p->x > 0) {
        p->x = 0;
    }
};
...
auto constexpr PLAYER_LEFT_KEYUP = [](Point* p) {
    if (p->x < 0) {
        p->x = 0;
    }
};
