...
class Controller {
  /* There are three types of events the Controller will handle; Keys, Buttons,
   * and Listeners Keys are for commands that have distinct states of down and
   * up Buttons are for actions that only activate when they key is held down,
   * but don't care when released
