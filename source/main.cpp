...
int main(int argc, char* argv[]) {
    ...
    contra.addPlayerKeys(
        popo);  // Maybe allow for multiple bindings of the same command
                // somehow? vectors likely? Also remove this dumb fix
    FpsText fps(
        gFont, Point(100, 10),
...
SDL_Window* createWindow() {
    return SDL_CreateWindow(
        Screen::WINDOW_TITLE.c_str(), Screen::DEFAULT_POS, Screen::DEFAULT_POS,
