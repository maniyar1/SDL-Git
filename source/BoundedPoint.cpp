...
BoundedPoint::BoundedPoint(float xpos, float ypos, float xMin, float yMin,
...
BoundedPoint::BoundedPoint(Point pos, float xMin, float yMin, float xMax,
                           float yMax)
    : Point(pos) {
    this->xMin = xMin;
    this->xMax = xMax;
...
BoundedPoint::BoundedPoint(const BoundedPoint& other)
...
void BoundedPoint::zeroX() { this->x = 0; }

void BoundedPoint::zeroY() { this->y = 0; }

void BoundedPoint::maxX() { this->x = this->xMax; }

void BoundedPoint::maxY() { this->y = this->yMax; }
