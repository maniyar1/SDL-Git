...
BackElement::BackElement(Point position, const std::string& type)
...
BackElement::~BackElement() { this->texture = NULL; }
...
std::shared_ptr<Texture> BackElement::createGroundTexture(
    SDL_Renderer* renderer, const std::string& type) {
