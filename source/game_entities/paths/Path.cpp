...
Path::~Path() { this->target = NULL; }

void Path::setTarget(EnemyBase* target) { this->target = target; }
...
void Path::unpause() { this->timer.unpause(); }

bool Path::isPaused() { return this->timer.isPaused(); }
